...
all: test_image test_tile_math test_rasterizer test_polyfill test_thick_line
...
clean:
	rm -f test_image test_tile_math test_rasterizer test_polyfill test_thick_line *.o
